                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('role_id') is-invalid @enderror" id="role_id" name="role_id" required readonly="true">
                                ...
                                @foreach ($roles as $role)
                                    <option value="{{$role->id}}" @if($currentRole->id == $role->id) selected @endif>
                                        {{$role->name}}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('cod_club') is-invalid @enderror" id="cod_club" name="cod_club">
                                    ...
                                    @foreach ($clubes as $club)
                                        <option value="{{$club->CodClub}}" @if($user->NombreWeb == $club->CodClub) selected @endif>
                                            {{$club->Club}}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_fed') is-invalid @enderror" id="id_fed" name="id_fed">
                                    ...
                                    @foreach ($federaciones as $fed)
                                        <option value="{{$fed->IdFed}}" @if($user->IdFed == $fed->IdFed) selected @endif>
                                            {{$fed->Federacion}}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="confirm_password" type="password" class="form-control @error('confirm_password') is-invalid @enderror" name="confirm_password" value="">
        ...
        if ($('#form').valid()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    var msg= {
                        "title"         : "Éxito",
                        "notification"  : "Usuario actualizado exitosamente.",
                        "type"          : "success",
                    };
                    toastrFire (msg);
                    /**
