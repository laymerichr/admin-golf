                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtFecha" type="date" class="form-control  datepicker @error('fecha') is-invalid @enderror" name="txtFecha" value="{{$torneo->fecha1}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtHora" type="time" class="form-control @error('hora') is-invalid @enderror" name="txtHora" value="{{$torneo->hora_creacion}}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtFecha0ins_h" type="date" class="form-control  datepicker @error('fecha') is-invalid @enderror" name="txtFecha0ins_h" value="{{$torneo->fecha0ins}}" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtFecha1ins_h" type="date" class="form-control  datepicker @error('fecha') is-invalid @enderror" name="txtFecha1ins_h" value="{{$torneo->fecha1ins}}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtDireccion" type="text" class="form-control" name="txtDireccion" value="{{$torneo->direccion}}" required >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtTelefono" type="text" class="form-control" name="txtTelefono" value="{{$torneo->telefono_contacto}}" required >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtWeb" type="text" class="form-control" name="txtWeb" value="{{$torneo->web}}" required >
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="txtPrecio" type="text" class="form-control" name="txtPrecio" value="{{$torneo->precio_torneo}}" required >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group ui-front">
                                ...
                                <textarea class="form-control" {{--aria-label="With textarea"--}} rows="8" id="textarea_v" name="textarea_v" required>{{$torneo->Text_Area}}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="txtCmVisible" name="txtCmVisible" required style="width: 100%">
                                    <option value="1" @if($torneo->visible) selected @endif ><span style="color: #888;">Si</span></option>
                                    <option value="0" @if(!$torneo->visible) selected @endif><span style="color: #888;">No</span></option>
                                </select>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input id="url_inscrip" type="text" class="form-control" name="url_inscrip" value="{{$torneo->url}}" readonly >
                            </div>
                        </div>
                    </div>
                </div>
        ...
        if ($('#form').valid()) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    var msg= {
                        "title"         : "Éxito",
                        "notification"  : "Torneo actualizado exitosamente.",
                        "type"          : "success",
                    };
                    toastrFire (msg);
                    /**
