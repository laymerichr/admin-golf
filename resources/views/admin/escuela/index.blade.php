...
@section('title', 'Escuelas Tuteladas')
        ...
        <div class="content px-3">
            ...
            <div class="card card-outline card-primary">
                <div class="card-body">
                    <div class="row">
                        <div class="col-3">
                            <img src="{{asset('assets/img/escuelas/club_on.jpg')}}"  width="100" height="100" alt="" style="">
                        </div>

                        <div class="col-6">
                            <p class="cabecera_importante" style="font-size:18px; color: #87B91C;">ESCUELA NACIONAL JUVENIL</p>
                            <p class="cabecera_importante" style="font-size:18px;">REAL FEDERACIÓN ESPAÑOLA DE GOLF</p>
                        </div>

                        <div class="col-3">
                            <a href="http://www.rfegolf.es/default.aspx" title="REAL FEDERACIÓN ESPAÑOLA DE GOLF" target="_blank">
                                <img class="float-right" src="{{asset('assets/img/escuelas/rfegolf_on.png')}}"  width="100" height="100" alt="REAL FEDERACIÓN ESPAÑOLA DE GOLF">
                            </a>
