                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="id_fed" name="id_fed" required readonly="true">
                                    <option value="">
                                        Seleccionar
                                    </option>
            ...
            $.ajax({
                ...
                success: function (data) {
                   ...
                   console.log(data)
                    var msg= {
                        "title"         : "Éxito",
                        "notification"  : "Firma creada exitosamente.",
                        "type"          : "success",
                    };
                    toastrFire (msg);
                    /**
